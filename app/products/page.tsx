...
export default function ProductsPage() {
  ...
  return (
    <main className="min-h-screen bg-[#FAFAFA] text-[#111111] relative">
      ...
      <PageHero
        title="LUXURY SALON CARE PRODUCTS"
        subtitle="Discover our curated collection of professional haircare, styling pomades, hydrafacial serums, and beauty essentials."
      />
